...
class _$CardStateImpl implements _CardState {
  ...
  @override
  String toString() {
    return 'CardState(loading: $loading, succes: $succes, message: $message, currentCardInfo: $currentCardInfo, transactions: $transactions, pciUrl: $pciUrl, cardBalance: $cardBalance, createdCardId: $createdCardId, pendingWithdrawalId: $pendingWithdrawalId, pendingTransferId: $pendingTransferId)';
  }
...
abstract class _CardState implements CardState {
  const factory _CardState(
      ...
      final String createdCardId,
      final String pendingWithdrawalId,
      final String pendingTransferId}) = _$CardStateImpl;
